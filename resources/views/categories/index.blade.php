  ...
  <div class="card-body">
    ...
    <div class="tab-content" id="categoryTabsContent">
      ...
      <div class="tab-pane fade" id="inactive" role="tabpanel">
        @php $inActiveCategories = $categories->where('is_active', false); @endphp
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr class="{{ $isExceeded ? 'table-danger' : ''}}">
                <td>
                  <div class="d-flex align-items-center">
                    <div class="transaction-icon {{ $category->type == CategoryType::EXPENSE ? 'bg-danger' : 'bg-success'}} text-white me-3">
                      <i class="bi {{ $category->icon_class }}"></i>
                    </div>
                    <div>
                      <h6 class="mb-0">{{ $category->name }}</h6>
                ...
                <td>
                  @if($category->type == CategoryType::INCOME)
                  <span class="badge bg-success">{{ CategoryType::INCOME}}</span>
                  @else
                  <span class="badge bg-danger">{{ CategoryType::EXPENSE}}</span>
                  @endif
                </td>
                <td>
                  @if($category->budget_limit)
        ...
        @else 
        <div class="text-center py-4">
          <p class="text-muted">Belum ada kategori tidak aktif</p>
        </div>
        @endif
      </div>
    </div>
