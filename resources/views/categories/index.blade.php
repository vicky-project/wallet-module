                        ...
                        <div class="col-md-4 mb-3">
                            <div class="d-flex align-items-center">
                                <div class="transaction-icon me-3" 
                                     style="background-color: #f8961e; color: white;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover">
                            ...
                            <tbody id="categoryTableBody">
                                ...
                                @endphp
                                <tr data-type="{{ $category->type }}" 
                                    data-status="{{ $category->is_active ? 'active' : 'inactive' }}"
                                    class="{{ $isExceeded ? 'table-danger' : '' }}">
                                    <td>{{ $index + 1 }}</td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="transaction-icon" 
                                                 style="background-color: {{ $category->color ?? ($category->type === 'income' ? '#10b981' : '#ef4444') }}; color: white;">
                                    ...
                                    <td class="text-end">
                                        <div class="btn-group" role="group">
                                            <a href="{{ route('apps.categories.show', $category) }}" 
                                            ...
                                            <form action="{{ route('apps.categories.toggle-status', $category) }}" 
                                            ...
                                            <form action="{{ route('apps.categories.destroy', $category) }}" 
                                                  method="POST" class="d-inline">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn btn-sm btn-outline-danger" 
                                                        onclick="return confirm('Hapus kategori ini? Transaksi yang terkait akan tetap ada.')">
