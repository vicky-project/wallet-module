...
<div class="row">
    <div class="col-12">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            ...
            <a href="{{ route('apps.categories.create') }}" class="btn btn-sm" style="background-color: var(--tg-theme-button-color); color: var(--tg-theme-button-text-color); border: none;" onclick="showToast('Tambah kategori', 'info')">
                            ...
                            <tr style="border-bottom: 1px solid var(--tg-theme-section-separator-color);">
                                ...
                                <td class="text-end pe-4">
                                    <div class="d-flex gap-1 justify-content-end">
                                        <a href="{{ route('apps.categories.edit', $category) }}" class="btn btn-sm btn-outline-secondary rounded-circle" style="width: 32px; height: 32px; padding: 0;" title="Edit">
