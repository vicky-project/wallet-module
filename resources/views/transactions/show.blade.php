        ...
        <div class="col-lg-8">
            ...
            <div class="card transaction-detail-card mb-4">
                <div class="card-body text-center py-4">
                    <div class="transaction-icon-large {{ $transaction->type == 'income' ? 'bg-income' : 'bg-expense' }} mb-3">
                        <i class="bi {{ $transaction->type == 'income' ? 'bi-arrow-up-circle text-income' : 'bi-arrow-down-circle text-expense' }}"></i>
                    </div>
                    
                    <h2 class="{{ $transaction->type == 'income' ? 'text-income' : 'text-expense' }} mb-2">
                    ...
                    <div class="d-flex justify-content-center gap-2 mb-3">
                        <span class="badge {{ $transaction->type == 'income' ? 'bg-income' : 'bg-expense' }} tag-badge">
            ...
            <div class="card transaction-detail-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <div>
                            <form action="{{ route('apps.transactions.destroy', $transaction->id) }}" 
                                  method="POST" 
                                  class="d-inline"
