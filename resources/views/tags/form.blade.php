          ...
          <div class="mb-3">
            ...
            <div class="input-group">
              ...
              <select class="form-select @error('icon') is-invalid @enderror" id="icon" name="icon">
                ...
                @foreach([
                  'bi-tag' => 'Tag',
                  'bi-tag-fill' => 'Tag (fill)',
                  'bi-cart' => 'Keranjang',
                  'bi-cart-fill' => 'Keranjang (fill)',
                  'bi-car-front' => 'Mobil',
                  'bi-car-front-fill' => 'Mobil (fill)',
                  'bi-cup' => 'Cangkir',
                  'bi-cup-fill' => 'Cangkir (fill)',
                  'bi-house' => 'Rumah',
                  'bi-house-fill' => 'Rumah (fill)',
                  'bi-heart' => 'Hati',
                  'bi-heart-fill' => 'Hati (fill)',
                  'bi-bag' => 'Tas',
                  'bi-bag-fill' => 'Tas (fill)',
                  'bi-film' => 'Film',
                  'bi-film-fill' => 'Film (fill)',
                  'bi-book' => 'Buku',
                  'bi-book-fill' => 'Buku (fill)',
                  'bi-gift' => 'Hadiah',
                  'bi-gift-fill' => 'Hadiah (fill)',
                  'bi-airplane' => 'Pesawat',
                  'bi-airplane-fill' => 'Pesawat (fill)',
                  'bi-telephone' => 'Telepon',
                  'bi-telephone-fill' => 'Telepon (fill)',
                  'bi-wifi' => 'WiFi',
                  'bi-wifi-fill' => 'WiFi (fill)',
                  'bi-lightning' => 'Petir',
                  'bi-lightning-fill' => 'Petir (fill)',
                  'bi-droplet' => 'Tetes',
                  'bi-droplet-fill' => 'Tetes (fill)',
                  'bi-music-note' => 'Musik',
                  'bi-music-note-fill' => 'Musik (fill)'
                ] as $icon => $label)
                  <option value="{{ $icon }}" @selected(old('icon', $tag->icon ?? '') == $icon)>
                    {{ $label }}
                  </option>
                @endforeach
              </select>
