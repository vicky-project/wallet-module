...
<div class="row">
  @forelse($accounts as $account)
    <div class="col-xl-3 col-lg-4 col-md-6 mb-4">
      <div class="card account-card h-100" style="border-left: 5px solid {{ $account->color }};">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-start mb-3">
            <div>
              <div class="account-icon mb-2" style="width: 50px; height: 50px; background: {{ $account->color }}; color: white; border-radius: 10px; display: flex; align-items: center; justify-content: center;">
            ...
            <div class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li>
                  <a class="dropdown-item" href="{{ route('apps.accounts.show', $account) }}">
                    <i class="bi bi-eye me-2"></i>Detail
                  </a>
                </li>
                <li>
                  <a class="dropdown-item" href="{{ route('apps.accounts.edit', $account) }}">
                    <i class="bi bi-pencil me-2"></i>Edit
                  </a>
                </li>
                @if(!$account->is_default)
                <li>
                  <form action="{{ route('apps.accounts.toggle-default', $account) }}" method="POST" class="d-inline">
                    @csrf
                    @method('PUT')
          ...
          <div class="mt-3">
            <a href="{{ route('apps.accounts.show', $account) }}" class="btn btn-outline-primary btn-sm w-100">
