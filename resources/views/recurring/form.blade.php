            ...
            <div class="col-lg-8">
                                ...
                                <div class="row g-2">
                                    <div class="col-4">
                                        <input type="radio" 
                                               ...
                                               id="type_income" 
                                               value="income"
                                               {{ old('type', $recurringTransaction->type ?? '') == 'income' ? 'checked' : '' }}
                                               required>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="frequency-options">
                                @foreach(['daily' => 'Harian', 'weekly' => 'Mingguan', 'monthly' => 'Bulanan', 'quarterly' => 'Triwulan', 'yearly' => 'Tahunan'] as $value => $label)
                                    <div class="frequency-option {{ old('frequency', $recurringTransaction->frequency ?? 'monthly') == $value ? 'active' : '' }}"
                                        ...
                                        <input type="radio" 
                                               ...
                                               name="frequency" 
                                               value="{{ $value }}"
                                               {{ old('frequency', $recurringTransaction->frequency ?? 'monthly') == $value ? 'checked' : '' }}
                                               required>
                                    </div>
                                @endforeach
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" 
                                           ...
                                           id="interval" 
                                           name="interval"
                                           value="{{ old('interval', $recurringTransaction->interval ?? 1) }}"
                                           min="1"
                                           max="12">
                        ...
                        <!-- Frequency Details -->
                        <div class="frequency-detail {{ old('frequency', $recurringTransaction->frequency ?? '') == 'weekly' ? 'active' : '' }}" 
                             id="weekly_detail">
                            <div class="row">
                                <div class="col-12">
                                        ...
                                        @foreach($days as $index => $day)
                                            <div class="col">
                                                <input type="radio" 
                                                       ...
                                                       value="{{ $index }}"
                                                       {{ old('day_of_week', $recurringTransaction->day_of_week ?? date('w')) == $index ? 'checked' : '' }}>
                        ...
                        <div class="frequency-detail {{ in_array(old('frequency', $recurringTransaction->frequency ?? ''), ['monthly', 'quarterly']) ? 'active' : '' }}" 
                             id="monthly_detail">
                            <div class="row">
                                <div class="col-md-6">
                                    <label for="day_of_month" class="form-label">Hari dalam Bulan *</label>
                                    <select class="form-select @error('day_of_month') is-invalid @enderror" 
                                            id="day_of_month" 
                                            name="day_of_month">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="date" 
                                       ...
                                       id="start_date" 
                                       name="start_date"
                                       value="{{ old('start_date', $recurringTransaction->start_date ?? date('Y-m-d')) }}"
                                       required>
                                @error('start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" 
                                       ...
                                       id="end_date" 
                                       name="end_date"
                                       value="{{ old('end_date', $recurringTransaction->end_date ?? '') }}">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                ...
                                <input type="number" 
                                       class="form-control @error('remaining_occurrences') is-invalid @enderror" 
                                       id="remaining_occurrences" 
                                       name="remaining_occurrences"
                                       value="{{ old('remaining_occurrences', $recurringTransaction->remaining_occurrences ?? '') }}"
                                       min="1">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        @if(isset($recurringTransaction))
                            <hr class="my-3">
                            <div class="d-grid gap-2">
                                <a href="{{ route('wallet.recurring.show', $recurringTransaction->id) }}" 
